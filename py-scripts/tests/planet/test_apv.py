...
def test_analyze_apv():
    ...
    except_result = Apv(
        100,
        "30440220158a25b03dc8a66c231f1e009de5094068c165d573eb291d464a6fb69a87633d022052b4fe86b4843f5ed9e5b1bf35ada93f01173e7e8d11bd9d64918130f47c9cd3",  # noqa
        ADDRESS,
        {"test": "test"},
        raw_apv,
    )

    result = planet.analyze_apv(raw_apv)

    assert result == except_result


def test_sign_apv_v2():
    planet = Planet()
    ...
    expect_result = Apv(
        100,
        "304402200ddf1f95abc52d56df1ade7ad53eeed7d8759795e421f38dbac4b235416b22e902206e219c6013dea7c36f7a855ac2c36dc5b639b0499f3eaa80f0f2dd194b7d976b",  # noqa
        ADDRESS,
        {
    ...
    result = planet.sign_apv_v2(
        PASSPHRASE,
        "internal",
        100,
        "2022-03-02",
        "1/86993a417d6e64ce902e916d680db14cc97653f1",
        "1/884cc7966457d503ef6156f148cade634b72a1b",
    )
